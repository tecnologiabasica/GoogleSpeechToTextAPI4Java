...
public class JApiController {
    ...
    public JResponse recognize(Map<String, String> queryParam, JRequest entity, IApiListener listener) {
        responseListener = listener;
        JResponse syncEntity = null;
        JApiInterface.ApiInterface serviceApi = JApiInterface.getGenericApiClient(apiUrl);
        Call<JResponse> call = serviceApi.recognize(queryParam, entity);
